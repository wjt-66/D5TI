...
const poetDescriptions = {
    ...
    "ESTP": {
        poet: "前锋",
        description: " “芜湖~~耶！” 你与威廉·艾利斯真是心有灵犀，你是天生的行动派，充满能量，喜欢在风浪中搏击，勇于冲锋陷阵，拥有全庄园最快的大学生修速。虽然神秘工夫已经学费了，需要加强，但你总是抱着橄榄球直冲向监管者，用一次又一次的拉球诉说着版本的不公与极致的手法，好秀啊好秀啊。",
        imageUrl: "image/前锋.jpeg"
    },
    "ESFP": {
        poet: "杂技演员",
        description: " 你与麦麦头共享同一副性格骨架。你是人群中的焦点，充满了表演欲与感染力，像麦克一样用肢体语言向世界传递快乐。那个在旅行马戏团“喧嚣”里长大的金发男孩，拥有卷曲的金发和湛蓝的眼睛，人们永远不会从那眼神里看到一丝忧愁。他就是为舞台而生的王者，永远能在最危险的时刻反败为胜。ESFP是真正活在当下的表演者，而麦克正是如此——他把每一场追逐都当作一场盛大的杂技秀，用跳跃、翻滚和抛球去点燃观众的激情，在聚光灯下忘我地闪耀。",
        imageUrl: "image/杂技演员.jpg"
    },
    "ENFP": {
        poet: "画家",
    ...
    "ENTJ": {
        poet: "骑士",
        description: " 你与楼梯有着不解之缘，是天生的战略家和领导者，像理查德一样意志坚定且气场强大，在混乱中总能掌控全局，在楼梯上挥斥方遒。出身地下产业的斯特林家，理查德以爱为名，像手握棋子的君王般隐秘地操控着家族的命运。虽然救人压力大，但是荣誉共鸣机制很好地弥补了这一点，ENTJ的果决、组织力和天生的支配欲，在理查德身上体现得淋漓尽致——他从不被动等待命运降临，而是主动出击，制定规则，将一切纳入掌控。",
...
function getOptionText(questionId, option) {
    const optionTexts = {
        ...
        7: { A: "利用熟悉的地形、固定板窗交互，稳扎稳打牵制", B: "我想打一波很难的操作，打出来就是赢" },
